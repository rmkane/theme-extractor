...
function getTokenColor(theme: Theme, type: string): string | undefined {
  switch (type) {
    ...
    case 'primitive-type':
      return theme.colors.primitiveType || theme.colors.typeName || theme.colors.reservedWord
    case 'parameter-type':
      return (
    ...
    case 'type':
      return theme.colors.typeName || theme.colors.className || theme.colors.reservedWord
    case 'class':
    case 'annotation':
      return theme.colors.className
    case 'function-declaration':
      return theme.colors.functionDeclaration || theme.colors.functionName || theme.colors.className
    case 'function-call':
      return theme.colors.functionCall || theme.colors.functionName || theme.colors.className
    case 'function':
      return (
    ...
    case 'parameter':
      return theme.colors.parameter || theme.colors.plain || undefined
    case 'variable':
      return theme.colors.variable || theme.colors.plain || undefined
    case 'member':
      return (
        theme.colors.member ||
    ...
    case 'operator':
      return theme.colors.operator || theme.colors.plain || undefined
    case 'punctuation-paren':
      return (
        theme.colors.punctuationParen || theme.colors.punctuation || theme.colors.plain || undefined
      )
    ...
    case 'punctuation-brace':
      return (
        theme.colors.punctuationBrace || theme.colors.punctuation || theme.colors.plain || undefined
      )
    ...
    case 'punctuation':
      return theme.colors.punctuation || theme.colors.plain || undefined
    case 'plain':
      return theme.colors.plain || undefined
    default:
      return undefined
  }
}

function getTokenStyle(theme: Theme, type: string): string | null {
